...
var demos = [
    ...
    {title: "SLIM",
     ...
     media: [
         {video: "./assets/slim_mulch.mp4", caption: "[Mulch] red cube -> red basket"},
         {video: "./assets/slim_obstacle.mov", caption: "[Obstacles] red cube -> blue basket"},
         {video: "./assets/slim_grass.MOV", caption: "[Grass] yellow cube -> red basket"},
         {video: "./assets/slim_distractors.mov", caption: "[Concrete surface] green cube -> red basket"},
     ]
    }
];
